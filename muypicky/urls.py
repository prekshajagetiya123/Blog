...
urlpatterns = [
    ...
    # url(r'^restaurants/nonveg$', NonVegRestaurantListView.as_view()),
    # url(r'^restaurants/(?P<pk>\w+)/$', RestaurantListView.as_view()), 
    # url(r'^restaurants/veg$', VegRestaurantListView.as_view()),
]
